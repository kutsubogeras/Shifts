 ...
 */
public class ShiftSettings extends PreferenceActivity {
    /**
    ...
    public static final String NOTIFY_MESSAGE = "notifications_new_message";
    public static final String KEY_SELECTED_VIBRATE = "notifications_new_message_vibrate";
    public static final String KEY_SELECTED_PASSWORD  = "add_pass";
    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener =
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                String checValue = (boolVal)? "active": "inactive";
                preference.setSummary(checValue);
            }
            else {
                //if it is a password preference
                if(preference.getKey().toString().equals(KEY_PASSWORD)) {
                    for(int i=0; i<stringValue.length();i++) {
                        char ch = stringValue.charAt(i);
                        char n ='*';
                        stringValue = stringValue.replace(ch, n);
                    }
    ...
    private static void bindPreferenceSummaryToValue(Preference preference) {
        ...
        if(preference instanceof CheckBoxPreference) {
            boolean CheckboxPreference = prefs.getBoolean(preference.getKey(), false);
            sBindPreferenceSummaryToValueListener.onPreferenceChange(preference, CheckboxPreference);
        }
        else
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || PreferenceBackgroundFragment.class.getName().equals(fragmentName);
    }
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference(KEY_SELECTED_PASSWORD));
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            int id = item.getItemId();
            if (id == android.R.id.home) {
                startActivity(new Intent(getActivity(), ShiftSettings.class));
                return true;
            }
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class PreferenceBackgroundFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
